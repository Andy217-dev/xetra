  ...
  [814],
  {
    5429: function (e, t, r) {
      ...
      class C extends P {
        ...
        static isOnCurve(e) {
          return x(new C(e).toBytes());
        }
      }
      (C.default = new C("11111111111111111111111111111111")),
        E.set(C, { kind: "struct", fields: [["_bn", "u256"]] }),
      ...
      class F {
        ...
        static compile(e) {
          ...
          let [s, n] = t.getMessageComponents(),
            o = new z(n, i).compileInstructions(e.instructions);
          return new F({
            header: s,
            staticAccountKeys: n,
            recentBlockhash: e.recentBlockhash,
        ...
        serialize() {
          ...
          let n = f.n_([
              ...
              f.A9(K(), this.staticAccountKeys.length, "staticAccountKeys"),
              K("recentBlockhash"),
        ...
        static deserialize(e) {
          ...
          let s = {
            ...
            n = [],
            o = G(t);
          for (let e = 0; e < o; e++) n.push(new C(X(t, 0, 32)));
...
Missing signature for public key${
      ...
      class et {
        ...
        static deserialize(e) {
          let t = [...e],
            r = [],
            i = G(t);
          for (let e = 0; e < i; e++) r.push(new Uint8Array(X(t, 0, W)));
      ...
      let er = new C("SysvarC1ock11111111111111111111111111111111");
      new C("SysvarEpochSchedu1e111111111111111111111111"),
        new C("Sysvar1nstructions1111111111111111111111111");
      let ei = new C("SysvarRecentB1ockHashes11111111111111111111"),
        es = new C("SysvarRent111111111111111111111111111111111");
      ...
      let en = new C("SysvarStakeHistory1111111111111111111111111");
...
` +
      ...
      let ed = f._O("lamportsPerSignature"),
        eh = f.n_([
          f.Jq("version"),
          f.Jq("state"),
          K("authorizedPubkey"),
          K("nonce"),
          f.n_([ed], "feeCalculator"),
        ]),
        eg = eh.span;
      class ep {
        constructor(e) {
      ...
      let ef = (e) => ({ decode: e.decode.bind(e), encode: e.encode.bind(e) }),
        ...
        eb = Object.freeze({
          ...
          Assign: {
            index: 1,
            layout: f.n_([f.Jq("instruction"), K("programId")]),
          },
          Transfer: {
            index: 2,
            layout: f.n_([f.Jq("instruction"), em("lamports")]),
          },
          CreateWithSeed: {
            index: 3,
            layout: f.n_([
          ...
          InitializeNonceAccount: {
            index: 6,
            layout: f.n_([f.Jq("instruction"), K("authorized")]),
          },
      ...
      class ey {
        ...
        static transfer(e) {
          ...
          return (
            "basePubkey" in e
              ...
              : ((t = el(eb.Transfer, { lamports: BigInt(e.lamports) })),
                (r = [
                  { pubkey: e.fromPubkey, isSigner: !0, isWritable: !0 },
                  { pubkey: e.toPubkey, isSigner: !1, isWritable: !0 },
                ])),
        ...
        static assign(e) {
          ...
          return (
            "basePubkey" in e
              ...
              : ((t = el(eb.Assign, { programId: R(e.programId.toBuffer()) })),
                (r = [
        ...
        static nonceInitialize(e) {
          let t = el(eb.InitializeNonceAccount, {
        ...
        static nonceAdvance(e) {
          let t = el(eb.AdvanceNonceAccount);
          return new Y({
            keys: [
              { pubkey: e.noncePubkey, isSigner: !1, isWritable: !0 },
              { pubkey: ei, isSigner: !1, isWritable: !1 },
        ...
        static nonceWithdraw(e) {
          let t = el(eb.WithdrawNonceAccount, { lamports: e.lamports });
          return new Y({
            keys: [
              { pubkey: e.noncePubkey, isSigner: !1, isWritable: !0 },
              { pubkey: e.toPubkey, isSigner: !1, isWritable: !0 },
        ...
        static nonceAuthorize(e) {
          let t = el(eb.AuthorizeNonceAccount, {
        ...
        static allocate(e) {
          ...
          return (
            "basePubkey" in e
              ...
              : ((t = el(eb.Allocate, { space: e.space })),
                (r = [
                  { pubkey: e.accountPubkey, isSigner: !0, isWritable: !0 },
                ])),
            new Y({ keys: r, programId: this.programId, data: t })
      ...
      ey.programId = new C("11111111111111111111111111111111");
      class ek {
        constructor() {}
        ...
        static async load(e, t, r, i, s) {
          {
            ...
            if (null !== o) {
              ...
              o.data.length !== s.length &&
                (a = a || new ee()).add(
                  ey.allocate({ accountPubkey: r.publicKey, space: s.length })
                ),
                o.owner.equals(i) ||
                  (a = a || new ee()).add(
                    ey.assign({ accountPubkey: r.publicKey, programId: i })
                  ),
                o.lamports < n &&
                  (a = a || new ee()).add(
                    ey.transfer({
            ...
            null !== a && (await ec(e, a, [t, r], { commitment: "confirmed" }));
          }
          let n = f.n_([
              f.Jq("instruction"),
              f.Jq("offset"),
          ...
          for (; u.length > 0; ) {
            ...
            l.push(ec(e, h, [t, r], { commitment: "confirmed" })),
              e._rpcEndpoint.includes("solana.com") && (await eu(250)),
              (c += o),
              (u = u.slice(o));
          }
          await Promise.all(l);
      ...
      let ev = {
          ...
          layout: f.n_([
            ...
            f.u8(),
            f.A9(K(), f.cv(f.u8(), -1), "authority"),
          ]),
        },
        eB = /^[^:]+:\/\/([^:[]+|\[[^\]]+\])(:\d+)?(.*)/i,
        eR = (0, b.oQ)((0, b.eE)(C), (0, b.Z_)(), (e) => new C(e)),
        eP = (0, b.bc)([(0, b.Z_)(), (0, b.i0)("base64")]),
        eE = (0, b.oQ)((0, b.eE)(a.Buffer), eP, (e) =>
      ...
      let eO = (0, b.dt)({
        ...
        eZ = (0, b.IM)((0, b.Z_)(), (0, b.IX)((0, b.Rx)())),
        e$ = (0, b.AG)((0, b.G0)([(0, b.dt)({}), (0, b.Z_)()])),
        eX = (0, b.dt)({ err: e$ }),
            ...
            innerInstructions: (0, b.jt)(
              (0, b.AG)(
                (0, b.IX)(
                  (0, b.dt)({
                    index: (0, b.Rx)(),
                    instructions: (0, b.IX)((0, b.G0)([eD, eV])),
                  })
                )
              )
            ),
        ...
        e6 = eU(
          (0, b.dt)({
            ...
            nonCirculatingAccounts: (0, b.IX)(eR),
          })
        ),
        e9 = (0, b.dt)({
          amount: (0, b.Z_)(),
        ...
        ti = eU((0, b.IX)((0, b.dt)({ lamports: (0, b.Rx)(), address: eR }))),
        ts = (0, b.dt)({
          executable: (0, b.O7)(),
          owner: eR,
          lamports: (0, b.Rx)(),
        ...
        tn = (0, b.dt)({ pubkey: eR, account: ts }),
        to = (0, b.oQ)(
          (0, b.G0)([(0, b.eE)(a.Buffer), tt]),
          (0, b.G0)([eP, tt]),
          (e) => (Array.isArray(e) ? (0, b.Ue)(e, eE) : e)
        ),
        ta = (0, b.dt)({
          executable: (0, b.O7)(),
          owner: eR,
        ...
        tc = (0, b.dt)({ pubkey: eR, account: ta }),
        tu = (0, b.dt)({
          state: (0, b.G0)([
            (0, b.i0)("active"),
            (0, b.i0)("inactive"),
        ...
        th = (0, b.dt)({ subscription: (0, b.Rx)(), result: ez(ts) }),
        tg = (0, b.dt)({ pubkey: eR, account: ts }),
        tp = (0, b.dt)({ subscription: (0, b.Rx)(), result: ez(tg) }),
        tf = (0, b.dt)({
          parent: (0, b.Rx)(),
          slot: (0, b.Rx)(),
          root: (0, b.Rx)(),
        }),
        tm = (0, b.dt)({ subscription: (0, b.Rx)(), result: tf }),
        tb = (0, b.G0)([
          (0, b.dt)({
            type: (0, b.G0)([
        ...
        ty = (0, b.dt)({ subscription: (0, b.Rx)(), result: tb }),
        tk = (0, b.dt)({
          subscription: (0, b.Rx)(),
          result: ez((0, b.G0)([eX, eH])),
        }),
        tw = (0, b.dt)({ subscription: (0, b.Rx)(), result: (0, b.Rx)() }),
        tS = (0, b.dt)({
          pubkey: (0, b.Z_)(),
        ...
        tI = eL(
          (0, b.dt)({ current: (0, b.IX)(t_), delinquent: (0, b.IX)(t_) })
        ),
        tA = (0, b.G0)([
          (0, b.i0)("processed"),
          (0, b.i0)("confirmed"),
        ...
        tx = (0, b.dt)({
          ...
          err: e$,
          confirmationStatus: (0, b.jt)(tA),
        }),
        tv = eU((0, b.IX)((0, b.AG)(tx))),
        tB = eL((0, b.Rx)()),
        tR = (0, b.dt)({
          accountKey: eR,
        ...
        tP = (0, b.dt)({
          ...
          message: (0, b.dt)({
            ...
            addressTableLookups: (0, b.jt)((0, b.IX)(tR)),
          }),
        }),
        tE = (0, b.dt)({
          pubkey: eR,
        ...
        tU = (0, b.oQ)(tq, tL, (e) =>
          "accounts" in e ? (0, b.Ue)(e, tW) : (0, b.Ue)(e, tC)
        ),
        tz = (0, b.dt)({
          signatures: (0, b.IX)((0, b.Z_)()),
          message: (0, b.dt)({
            ...
            recentBlockhash: (0, b.Z_)(),
            addressTableLookups: (0, b.jt)((0, b.AG)((0, b.IX)(tR))),
          }),
        }),
        tK = (0, b.dt)({
          accountIndex: (0, b.Rx)(),
        ...
        tO = (0, b.dt)({ writable: (0, b.IX)(eR), readonly: (0, b.IX)(eR) }),
        tN = (0, b.dt)({
          err: e$,
          fee: (0, b.Rx)(),
          innerInstructions: (0, b.jt)(
          ...
          preTokenBalances: (0, b.jt)((0, b.AG)((0, b.IX)(tK))),
          postTokenBalances: (0, b.jt)((0, b.AG)((0, b.IX)(tK))),
          loadedAddresses: (0, b.jt)(tO),
        ...
        tj = (0, b.G0)([(0, b.i0)(0), (0, b.i0)("legacy")]),
        tM = (0, b.dt)({
          pubkey: (0, b.Z_)(),
          lamports: (0, b.Rx)(),
        ...
        tD = eL(
          (0, b.AG)(
            (0, b.dt)({
              ...
              parentSlot: (0, b.Rx)(),
              transactions: (0, b.IX)(
                (0, b.dt)({ transaction: tP, meta: (0, b.AG)(tN) })
              ),
              rewards: (0, b.jt)((0, b.IX)(tM)),
              blockTime: (0, b.AG)((0, b.Rx)()),
            })
      ...
      class rt {
        ...
        async getBalanceAndContext(e, t) {
          ...
          if ("error" in o)
            throw new ea(o.error, `failed to get balance for ${e.toBase58()}`);
          return o.result;
        }
        ...
        async getMultipleParsedAccounts(e, t) {
          let { commitment: r, config: i } = eT(t),
            ...
            a = (0, b.Ue)(o, eU((0, b.IX)((0, b.AG)(ta))));
          if ("error" in a)
            throw new ea(a.error, `failed to get info for accounts ${s}`);
          return a.result;
        }
        async getMultipleAccountsInfoAndContext(e, t) {
          let { commitment: r, config: i } = eT(t),
            ...
            o = await this._rpcRequest("getMultipleAccounts", n),
            a = (0, b.Ue)(o, eU((0, b.IX)((0, b.AG)(ts))));
          if ("error" in a)
            throw new ea(a.error, `failed to get info for accounts ${s}`);
          return a.result;
        }
        ...
        async getProgramAccounts(e, t) {
          let { commitment: r, config: i } = eT(t),
            ...
            c = (0, b.IX)(tn),
            u =
              !0 === n.withContext ? (0, b.Ue)(a, eU(c)) : (0, b.Ue)(a, eL(c));
          if ("error" in u)
            throw new ea(
              u.error,
          ...
          let s,
            ...
            o = new Promise((t) => {
              ...
              (async () => {
                ...
                if (!n) {
                  for (; e <= r; )
                    if ((await eu(1e3), n || ((e = await i()), n))) return;
              ...
              (async () => {
                if (((n = await c()), !a))
                  for (;;) {
                    ...
                    if ((await eu(2e3), a || ((n = await c()), a))) return;
                  }
              })();
            }),
            ...
            if (t.__type === V.PROCESSED) o = t.response;
              ...
              if (i?.value) {
                ...
                switch (t) {
                  ...
                  case "single":
                  case "singleGossip":
                    if ("confirmed" !== r && "finalized" !== r) throw new U(n);
                    break;
                  case "finalized":
                  case "max":
                  case "root":
                    if ("finalized" !== r) throw new U(n);
                }
        ...
        async getInflationReward(e, t, r) {
          let { commitment: i, config: s } = eT(r),
            ...
            a = (0, b.Ue)(o, eN);
          if ("error" in a)
            throw new ea(a.error, "failed to get inflation reward");
          return a.result;
        }
        ...
        async getRecentBlockhashAndContext(e) {
          let t = this._buildArgs([], e),
            ...
            i = (0, b.Ue)(r, t0);
          if ("error" in i)
            throw new ea(i.error, "failed to get recent blockhash");
          return i.result;
        }
        ...
        async getTransaction(e, t) {
          ...
          return a
            ? {
                ...
                transaction: {
                  ...a.transaction,
                  message: eK(a.version, a.transaction.message),
                },
              }
            : a;
        }
        ...
        async getNonceAndContext(e, t) {
          let { context: r, value: i } = await this.getAccountInfoAndContext(
            ...
            s = null;
          return (
            null !== i && (s = ep.fromAccountData(i.data)),
            { context: r, value: s }
          );
        }
        async getNonce(e, t) {
        ...
        async _blockhashWithExpiryBlockHeight(e) {
          if (!e) {
            for (; this._pollingBlockhash; ) await eu(100);
        ...
        _wsOnAccountNotification(e) {
          let { result: t, subscription: r } = (0, b.Ue)(e, th);
        ...
        _wsOnProgramAccountNotification(e) {
          let { result: t, subscription: r } = (0, b.Ue)(e, tp);
        ...
        onProgramAccountChange(e, t, r, i) {
          let { commitment: s, config: n } = eT(r),
            o = this._buildArgs(
              [e.toBase58()],
        ...
        _wsOnSlotNotification(e) {
          let { result: t, subscription: r } = (0, b.Ue)(e, tm);
        ...
        _wsOnSlotUpdatesNotification(e) {
          let { result: t, subscription: r } = (0, b.Ue)(e, ty);
          this._handleServerNotification(r, [t]);
        }
        onSlotUpdate(e) {
          return this._makeSubscription(
      ...
      class rs {
        ...
        static deactivateLookupTable(e) {
          let t = el(ri.DeactivateLookupTable),
            r = [
              { pubkey: e.lookupTable, isSigner: !1, isWritable: !0 },
              { pubkey: e.authority, isSigner: !0, isWritable: !1 },
            ];
      ...
      rs.programId = new C("AddressLookupTab1e1111111111111111111111111");
      let rn = Object.freeze({
        ...
        SetComputeUnitPrice: {
          index: 3,
          layout: f.n_([f.u8("instruction"), em("microLamports")]),
        },
      });
      class ro {
        constructor() {}
        static requestUnits(e) {
          let t = el(rn.RequestUnits, e);
          return new Y({ keys: [], programId: this.programId, data: t });
        }
        static requestHeapFrame(e) {
          let t = el(rn.RequestHeapFrame, e);
          return new Y({ keys: [], programId: this.programId, data: t });
        }
        static setComputeUnitLimit(e) {
          let t = el(rn.SetComputeUnitLimit, e);
          return new Y({ keys: [], programId: this.programId, data: t });
        }
        static setComputeUnitPrice(e) {
          let t = el(rn.SetComputeUnitPrice, {
            microLamports: BigInt(e.microLamports),
          });
          return new Y({ keys: [], programId: this.programId, data: t });
        }
      }
      ro.programId = new C("ComputeBudget111111111111111111111111111111");
      let ra = f.n_([
        f.u8("numSignatures"),
        f.u8("padding"),
      ...
      rc.programId = new C("Ed25519SigVerify111111111111111111111111111");
      let ru = (e, t) => {
        let r = _.kA.sign(e, t);
        return [r.toCompactRawBytes(), r.recovery];
      };
      _.kA.utils.isValidPrivateKey;
      let rl = _.kA.getPublicKey,
        rd = f.n_([
          f.u8("numSignatures"),
          f.KB("signatureOffset"),
      ...
      rh.programId = new C("KeccakSecp256k11111111111111111111111111111");
      let rg = new C("StakeConfig11111111111111111111111111111111");
      class rp {
        constructor(e, t, r) {
      ...
      rp.default = new rp(0, 0, C.default);
      let rf = Object.freeze({
        Initialize: {
          index: 0,
          layout: f.n_([
            f.Jq("instruction"),
            ((e = "authorized") => f.n_([K("staker"), K("withdrawer")], e))(),
            ((e = "lockup") =>
              f.n_(
                [f.gM("unixTimestamp"), f.gM("epoch"), K("custodian")],
                e
              ))(),
          ]),
        },
      ...
      class rm {
        ...
        static authorize(e) {
          let {
            ...
            a = [
              { pubkey: t, isSigner: !1, isWritable: !0 },
              { pubkey: er, isSigner: !1, isWritable: !0 },
              { pubkey: r, isSigner: !0, isWritable: !1 },
            ];
          return (
      ...
      (rm.programId = new C("Stake11111111111111111111111111111111111111")),
        (rm.space = 200);
          ...
          layout: f.n_([
            ...
            ((e = "voteAuthorizeWithSeedArgs") =>
              f.n_(
                [
                  f.Jq("voteAuthorizationType"),
                  K("currentAuthorityDerivedKeyOwnerPubkey"),
      ...
      class ry {
        ...
        static updateValidatorIdentity(e) {
          let {
            ...
            s = el(rb.UpdateValidatorIdentity);
          return new ee().add({
            keys: [
              { pubkey: t, isSigner: !1, isWritable: !0 },
              { pubkey: i, isSigner: !0, isWritable: !1 },
      ...
      (ry.programId = new C("Vote111111111111111111111111111111111111111")),
        (ry.space = 3762),
        ...
        f.n_([
          ...
          f._O(),
          f.A9(
            f.n_([f._O("epoch"), K("authorizedVoter")]),
            f.cv(f.Jq(), -8),
            "authorizedVoters"
          ),
          f.n_(
